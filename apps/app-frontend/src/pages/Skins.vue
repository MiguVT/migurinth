	...
	<div v-else class="flex items-center justify-center min-h-[50vh] pt-[25%]">
		...
		>
			...
			<div class="flex flex-col gap-5">
				...
				<p class="text-lg m-0">
					Please sign into your Microsoft account to use the skin management features of the
					Modrinth app. You would need internet connection and have a valid minecraft license.
				</p>
